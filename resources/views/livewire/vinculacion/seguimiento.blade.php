<div>
    @if (Auth::user()->role === 'jefe')
        ...
        <h1 class="font-bold text-2xl mb-5">Estudiantes en Residencias</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="relative flex items-center rounded-full border-2 border-blue-500 px-2 py-1">
                ...
                <input type="search" wire:model.live="search"
                    ...
                    placeholder="Buscar alumno, empresa o vacante..." wire:keydown.escape="$set('search', '')">
            </div>
            <!-- Filtro por carrera -->
        ...
        @if ($datos->isEmpty())
            <div class="bg-gray-100 p-6 rounded-lg text-center">
                ...
                <p class="text-gray-600">
                    ...
                    @else
                        Actualmente no hay estudiantes en residencias
                    @endif
                </p>
                @if ($search || $periodoSeleccionado || $carreraSeleccionada)
                ...
                <table class="min-w-full bg-white rounded-lg overflow-hidden">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="py-3 px-4 text-left font-semibold text-gray-700">Último Archivo</th>
                            <th class="py-3 px-4 text-left font-semibold text-gray-700">Vacante</th>
